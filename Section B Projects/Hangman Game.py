from random_word import Wordnik       #pip install worknik
from PyDictionary import PyDictionary #pip install PyDictionary -> This module is used for the definition function
from textblob import Word             #pip install textblob -> This module is used for the spellchecking function
import string                         #imports libaries that include punctuation symbol lists and alphabetical and numerical lists
